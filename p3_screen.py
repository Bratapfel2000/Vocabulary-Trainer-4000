...
class Card:
    def __init__(self, label='noName', lang1="-", lang2="-", valcorrect=0, valwrong=0, picture_file='no file available'):
        self.label = label
        self.lang1 = lang1
        self.lang2 = lang2
...
class Deck:
    ...
    fields = cdw.fields_w_five_vals('words.csv')
...
class Ui_MainWindow(Session,Deck):
    def __init__(self,message=6,message_g2=1):               #644_g2_t_g3ie
    ...
    def setupUi(self, MainWindow):
        ...
        self.lineedit.setGeometry(QtCore.QRect(50, height_lineedit, 280, 50))
        ...
        self.label_lineedit.setGeometry(QtCore.QRect(50, 480, 400, 50))
...
##        self.label_header.setGeometry(QtCore.QRect(5, heigth_header, 111, 51))
##        self.label_header.setObjectName("label")

        #check button
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.hide()
        self.pushButton.setGeometry(QtCore.QRect(350, height_lineedit, 100, 50))
        ...
        self.pushButton_newword3.setGeometry(QtCore.QRect(200, 450, 200, 50))

        #what is field
        self.label_pushButton_newword3 = QtWidgets.QLabel(self.centralwidget)
        self.label_pushButton_newword3.setGeometry(QtCore.QRect(50, 25, 500, 50))
        ...
        self.foto1.setGeometry(QtCore.QRect(50, 75, 400, 300))
        self.foto1.setText("")
##        self.foto1.setPixmap(QtGui.QPixmap("../test/108389_04.JPG"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Vokabeltrainer 4000 - Feel The Pictures"))
...
##        word_pic = Ui_MainWindow.session.karteikasten[0].picture_file
        word_pic = Ui_MainWindow.session.karteikasten[0].picture_file
##        print(word_pic)
        if self.message_g2 == 1:
            word_lang1 = Ui_MainWindow.session.karteikasten[0].lang1
        ...
        self.label_pushButton_newword3.setText("What's that in "+ request_lang+"?   ("+str(len(self.session.karteikasten)-1)+" words left)")
        ...
        self.foto1.setPixmap(QtGui.QPixmap("pics/"+word_pic))
##        self.foto1.setPixmap(QtGui.QPixmap("pics/2.JPG"))
        self.lineedit.show()
